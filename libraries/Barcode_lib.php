...
class Barcode_lib
{
	...
	private $supported_barcodes = array('Ean13' => 'EAN 13');
	...
	{
		$display_table = "<div style='width:100%; height:100%; margin:10% auto; text-align:center;'>";
		// $display_table .= "<tr><td align='center'>" . $this->manage_display_layout($barcode_config['barcode_first_row'], $item, $barcode_config) . "</td></tr>";
		$display_table .= "<div class='text-center'>" .  substr($item['name'], 0, 20) . "</div>";
		$barcode = $this->generate_barcode($item, $barcode_config);
		$display_table .= "<div class='text-center'><img src='data:image/png;base64,$barcode' /></div>";
		$display_table .= "<div class='text-center'>" . $this->manage_display_layout($barcode_config['barcode_second_row'], $item, $barcode_config) . "</div>";
		$display_table .= "<div class='text-center'>" . $this->manage_display_layout($barcode_config['barcode_third_row'], $item, $barcode_config) . "</div>";
		$display_table .= "</div>";
