	...
	<?php echo form_open($controller_name."/change_mode", array('id'=>'mode_form', 'class'=>'form-horizontal panel panel-default')); ?>
		<div class="panel-body form-group">
			<ul>
				...
				<?php if($transfers > 0){ ?>
					<button class="btn btn-sm btn-danger pull-right modal-dlg-wide animated flash infinite" data-href='<?php echo site_url("receivings/st_view"); ?>'
							title='New Stock Transfer'>Items Received - Please Accept</button>
				<?php } ?>			
			</ul>
		</div>
	<?php echo form_close(); ?>
