...
<button class='btn btn-xs padding-5 bg-warning pull-right' style="margin-left:10px;" onclick='sheet_action(<?php echo $sheets[0]->parent_id;?>,"approve");'><span class='fa fa-check-square-o mar_r_7'></span>Approve</button>
<?php endif;?>
